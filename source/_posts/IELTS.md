...
Task2
主体段第二个分论点使用Also，furthermore， another benefit/advantage 引出，不用moreover
...
1. 注意时态
2. 看能否转成柱状图（单图）
3. 结尾段一定要有，总结尽量不要数字，overall  不要in conclusion
4. 画上升、下降箭头，double
...
proportion - percentage - ratio - distribution
...
the amount of（不可数）/ the number of（可数） / the figure for（可数/不可数）
quantities可数
chart -> bar chart
graph -> line graph
and→as well as
...
X. 按照时间变化，没有时间按从高到低
不一定要覆盖所有数字
起点，终点，变化趋势，转折点，极值，等值，用笔圈起来，倍数关系(需要计算)
By contrast 不同趋势对比
柱状图多组之间进行比较，趋势、大小
...
注意：
具体数字 + hundred, thousand, million, billion  保持单数
rise/rose，不用raise（表示happen）
...
rise / rose
grow / grew
show an upward trend / opposite trend
ascent
2. 下降
dip
decline
fall / fell                   fall back to   先上升，后回落
drop / dropped
decrease
show a downward trend
by 百分比/数字 上升、下降幅度
shows a negative pattern
3.  波动
fluctuate between   ***    and    			不能用被动
4. 稳定在某一水平
...
reach its peak at
7. 最低点
reach / (fall to) its lowest point / bottom at
a new low
8. 达到、位于
reach
stand at
...
13. 差距变小
gap between    narrowed over the period
14. 原来少于，后来超过
exceed
overtake
15. 在之前
...
similarly,  呈相同趋势
in contrast，
gap  between **** and ***   narrows / remains
...
```tex
um(不能用en), well, and, you know, I mean, like
That is a trick/tough question
I am not sure, 
I do not really know
I do not konw much about this, but
I have not thought about it before
Let me think about it
Hang on a second
Sorry,  I forgot the word I wanna say
I do not know what it is in English, but it is just like 
That was a slip of my tongue.
The word is on the tip of my tonguelobe the most is

especially
particularly
I particularly like
if I had to pick a favorite, I'd say it should be....
what I like/love the most is/should be...
the singer I like the most

for instance
let me give you an example
the last time I did it was
I remember clearly/vividly that ...


part2
I am going to talk about a *** about**
未来虚拟语气：I would like to ****

If I remember right
basically
there is room for improvement
There's no denying that we're living in a world where things are constantly changing and if we want to keep up with all the changes, we have to learn, nonstop.
